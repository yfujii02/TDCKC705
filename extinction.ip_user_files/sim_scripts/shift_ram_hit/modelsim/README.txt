<<<<<<< HEAD:extinction.ip_user_files/sim_scripts/shift_ram_hit/modelsim/README.txt
################################################################################
...
#
# Generated by export_simulation on Thu Feb 04 14:30:06 JST 2021
#
################################################################################
...
'-reset_run' switch to the './shift_ram_hit.sh' script.

./shift_ram_hit.sh -reset_run
...
./shift_ram_hit.sh -noclean_files

For more information on the script, please type './shift_ram_hit.sh -help'.
...
#             run the exported script and information about the source files.
#
# Generated by export_simulation on Fri Feb 05 10:31:15 +1100 2021
#
################################################################################
...
order to reset the current directory to the original state when export_simulation
was launched from Vivado. This generated data can be removed by specifying the
'-reset_run' switch to the './bram_2byte_2K.sh' script.

./bram_2byte_2K.sh -reset_run

To keep the generated data from the previous run but regenerate the setup files and
library directories, use the '-noclean_files' switch.

./bram_2byte_2K.sh -noclean_files

For more information on the script, please type './bram_2byte_2K.sh -help'.
...
Purpose: This file contains detail design file information based on the compile order
         ...
         about the file type, name, whether it is part of the IP, associated library
         and the file path information.
>>>>>>> 82d30bcdddea1ab3a785b38cc9ca2d00db4d7f72:extinction.ip_user_files/sim_scripts/bram_2byte_2K/activehdl/README.txt
