...
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_SMA[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_SMA[1]}]
...
#set_property IOSTANDARD LVCMOS15 [get_ports {GPIO_LED[4]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {GPIO_LED[5]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {GPIO_LED[6]}]
#set_property IOSTANDARD LVCMOS15 [get_ports {GPIO_LED[7]}]
...
#set_property PACKAGE_PIN AB9 [get_ports {GPIO_LED[4]}]
#set_property PACKAGE_PIN AC9 [get_ports {GPIO_LED[5]}]
#set_property PACKAGE_PIN AA8 [get_ports {GPIO_LED[6]}]
#set_property PACKAGE_PIN AB8 [get_ports {GPIO_LED[7]}]
