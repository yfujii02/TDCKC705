...
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_SMA_IN[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {GPIO_SMA_IN[1]}]
...
set_property PACKAGE_PIN Y23 [get_ports {GPIO_SMA_IN[0]}]
set_property PACKAGE_PIN Y24 [get_ports {GPIO_SMA_IN[1]}]
